...
import type { AnalyticsGetPromoCodeUsageHistoryParams } from '@entities/analytics';
import { isSuccessResponse } from '@shared/lib/utils/error.utils';
import { DateFilter, type DatePreset } from '@shared/ui';
import { PromoCodeUsageHistoryTable } from '../promo-code-usage-history-table';
import type { MRT_PaginationState, MRT_SortingState } from 'material-react-table';
import type { OnChangeFn } from '@tanstack/react-table';
import type { usePromoCodeUsageHistory } from '@features/analytics';
...
export const HistoryAnalyticsTab = memo(
    ({
        query,
        params,
        onParamsChange,
...
HistoryAnalyticsTab.displayName = 'HistoryAnalyticsTab';
