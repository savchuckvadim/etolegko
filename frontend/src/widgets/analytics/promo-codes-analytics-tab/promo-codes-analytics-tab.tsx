...
import type { AnalyticsGetPromoCodesListParams } from '@entities/analytics';
import { isSuccessResponse } from '@shared/lib/utils/error.utils';
import { DateFilter, type DatePreset } from '@shared/ui';
import { PromoCodesAnalyticsTable } from '../promo-codes-analytics-table';
import type { MRT_PaginationState, MRT_SortingState } from 'material-react-table';
import type { OnChangeFn } from '@tanstack/react-table';
import type { usePromoCodesAnalytics } from '@features/analytics';
...
PromoCodesAnalyticsTab.displayName = 'PromoCodesAnalyticsTab';
