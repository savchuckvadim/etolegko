...
export class PromoCodeUsageSchema {
  ...
  @Prop({ type: Types.ObjectId, ref: 'OrderSchema', required: true, unique: true })
...
export const PromoCodeUsageSchemaFactory = SchemaFactory.createForClass(PromoCodeUsageSchema);
 ...
 */
export function mapPromoCodeUsageDocumentToEntity(doc: PromoCodeUsageDocument): PromoCodeUsage {
